    ...
    <ul className="space-y-5">
      <li className="flex items-start group hover:bg-white/5 p-2 rounded-lg transition-all">
        ...
        <div className="text-left">
          <h4 className="font-medium text-base mb-1">Ons Adres</h4>
      ...
      <li className="flex items-center group hover:bg-white/5 p-2 rounded-lg transition-all">
        ...
        <div className="text-left">
          <h4 className="font-medium text-base mb-1">Telefoonnummer</h4>
      ...
      <li className="flex items-start group hover:bg-white/5 p-2 rounded-lg transition-all">
        ...
        <div className="text-left">
          <h4 className="font-medium text-base mb-1">E-mail</h4>
      ...
      <li className="flex items-center group hover:bg-white/5 p-2 rounded-lg transition-all">
        ...
        <div className="text-left">
          <h4 className="font-medium text-base mb-1">Openingstijden</h4>
