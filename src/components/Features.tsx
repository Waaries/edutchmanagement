...
const Features = () => {
  ...
  return <section id="voordelen" className="section-padding" ref={sectionRef}>
      <div className="container mx-auto container-padding reveal">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {featureItems.map((feature, index) => <div key={index} className="bg-white rounded-3xl p-8 hover-lift transition-all duration-300 card-shadow text-left" style={{
